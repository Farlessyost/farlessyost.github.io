...
The public scanner name is now Skopeo, at `/projects/skopeo/`; `/projects/xyz-robot/` redirects to it. Original project directories, CAD sources, scripts, and media filenames retain XYZ for continuity. The name is a portfolio project label; no trademark or commercial-name clearance is asserted.
