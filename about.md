...
<div class="shell">
  ...
  <section class="bio-section" aria-labelledby="toolkit"><h2 id="toolkit">Skills</h2><div class="skill-grid">
    ...
    <div><h3>Robotics and hardware</h3><p>ROS, ROS 2, MuJoCo, Gazebo, FreeCAD, ESP32, embedded firmware, 3D printing.</p></div>
  ...
  <section class="bio-section" aria-labelledby="experience"><h2 id="experience">Experience</h2><div>
    ...
    <div class="entry"><p class="meta">Independent projects</p><h3>Embedded sensing and robotics</h3><p>Developing Peepin on Papaw’s wireless sensors, event logging, and enclosures. Designing TetherFrame’s cable mechanism, simulation, and embedded controls for a locally buildable medical-scanning platform.</p></div>
