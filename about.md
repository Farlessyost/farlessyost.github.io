...
<div class="shell">
  ...
  <section class="bio-section" aria-labelledby="experience"><h2 id="experience">Experience</h2><div>
    ...
    <div class="entry"><p class="meta">Independent projects</p><h3>Embedded sensing and robotics</h3><p>Developing Peepin on Papaw’s wireless sensors, event logging, and enclosures. Designing Skopeo’s cable mechanism, simulation, and embedded controls for a locally buildable medical-scanning platform.</p></div>
