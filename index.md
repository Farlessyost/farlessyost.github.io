...
<section class="hero shell" aria-labelledby="intro-title">
  <div class="hero-copy">
    ...
    <div class="actions"><a class="button" href="{{ '/resume.pdf' | relative_url }}?v={{ site.resume_version }}">View résumé <span aria-hidden="true">↗</span><span class="sr-only"> (PDF)</span></a><a class="text-link" href="{{ '/projects/' | relative_url }}">View projects</a></div>
  </div>
