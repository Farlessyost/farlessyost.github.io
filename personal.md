...
title: Personal
permalink: /personal/
description: Family and time outdoors.
---
<div class="shell">
  <header class="page-header"><h1>Personal</h1><p class="page-deck">Family and time outdoors.</p></header>
    ...
    <section aria-labelledby="family-waterfall">
      ...
      <figure>
        <video controls playsinline preload="none" width="1920" height="1080" poster="{{ '/assets/images/family-waterfall-poster.jpg' | relative_url }}" aria-label="Family waterfall video">
          ...
          <p><a href="{{ '/assets/videos/family-waterfall.mp4' | relative_url }}">Watch the family waterfall video.</a></p>
        </video>
        <figcaption>1 min 6 sec. <a href="{{ '/assets/videos/family-waterfall.mp4' | relative_url }}">Open video</a></figcaption>
      </figure>
    </section>
